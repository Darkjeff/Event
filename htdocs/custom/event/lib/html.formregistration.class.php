    ...
    function show_form($width='120px')
    {
        ...
        if ($this->withevent)
        {
        	...
        	if ($this->fk_event > 0)
        	{
            	...
            	print '<a href="'.DOL_URL_ROOT.'/custom/event/card.php?id='.$this->fk_event.'&action=edit">'.img_picto($langs->trans('ChooseAnotherEvent'), 'edit').'</a>';
        		print '</td>';
        	}
        	else
        	{
        ...
        if ($this->witheventday)
        {
        	...
        	if ($this->fk_eventday > 0)
        	{
            	...
            	print '<a href="'.DOL_URL_ROOT.'/custom/event/day/card.php?action=edit&id='.$this->fk_eventday.'">'.img_picto($langs->trans('ChooseAnotherDay'), 'edit').'</a></td>';
        		// Date of eventday
