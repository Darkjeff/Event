...
if ($resql)
{
	...
	if ($num > 0) {
		...
		while ($i < $num)
		{
				...
				print $objp->df.' : <a target="_blank" href="'.DOL_URL_ROOT.'/document.php?modulepart=facture&file='.basename($filedir).'%2F'.$filename.'">'.$objp->nom.' <img src="'.DOL_URL_ROOT.'/theme/common/mime/pdf.png" /></a><br />';
				$i++;
		}
	}
	else{
