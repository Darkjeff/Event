...
dol_fiche_head($head, 'about', '', 0, 'assistant@assistant');

dol_include_once('/assistant/core/modules/modAssistant.class.php');
$tmpmodule = new modAssistant($db);
